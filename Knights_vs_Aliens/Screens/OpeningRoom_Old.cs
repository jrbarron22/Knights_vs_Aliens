...
{
    public class OpeningRoom_Old : IScreen
    {
        ...
        public OpeningRoom_Old(Game game, GraphicsDevice graphics, KnightSprite knight, ContentManager content, switchScreen swapScreen)
        {
        ...
        public void Update(GameTime gameTime)
        {
            ...
            {
                //pause(ScreenName.PauseScreen, ScreenName.OpeningRoom_Old);
                return;
            }
